            ...
            <div className="relative divide-y-2 divide-black">
                <div className="mx-auto max-w-prose text-lg  ">
                    <h1>
                        ...
                        <p className="text-center font-mono italic">新婚夫妇在愚人节当天组织了一个另类小集市</p>
                                ...
                                <table className="w-full text-center">
                                    <tbody className="text-black font-mono text-start">
                                        <tr className=" border-b-2 border-black">
                                            ...
                                            <td className="px-4 py-2 italic"><a className='underline decoration-solid' href="http://yami-ichi.biz/" target="_blank" rel="noreferrer" >互联网黑市</a> in Bombay Beach</td>
                                        </tr>
                                        ...
                                        <tr className="border-t-2 border-b-2 border-black">
                                            ...
                                            <td className="px-4 py-2 italic ">关上电脑,退出账号,进入现实世界。互联网黑市是一个让你面对面“浏览”的跳蚤市场。</td>
                                        </tr>
                                    </tbody>
                                </table>
                                <a target="_blank" rel="noreferrer" href="https://www.bbyi.fyi/">
                                    <button className="mt-10 pb-2 text-black border border-black border-2 font-bold font-mono py-2 px-4 italic   mb-10">🐟 来这里看看我们的脑洞吧!</button>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div className="xl:flex flex-col justify-center  h-full  border-black">
                        <h1 className="mt-10 font-mono italic block text-center text-3xl font-bold leading-8 tracking-tight text-gray-900 sm:text-4xl">刚结完婚的我们在14天里想出了14个脑洞,还把它们都完成了</h1>
                        <p className="px-4 mt-10 text-black font-mono italic">
                            事情的起因是这样的。去年10月的时候我和Jmill(现在的老公,当时的男朋友)去迈阿密探望朋友M和F,在他们的公寓大楼里散步的时候,M说他们打算在一月份搞一个Internat Yami-ichi,翻译过来就是互联网黑市。
                            起源于2012年的日本东京,由一个叫IDPW的互联网社团组织。一开始的起因是因为社员做的iOS app被苹果公司拒绝了,理由竟然是不够有用和娱乐性不足。一气之下他们决定把互联网带到现实世界,和人面对面交互,于是就有了这个活动。
                            后来这个黑市遍布了世界各地,以去中心化的形式被不同的人组织。只要和创始人的人说一声你要举办就行,成功举办后他们还会把你的活动信息和照片放在官网上。
                            Jmill一听到这个活动就两眼放光,一月份的黑市虽然参与不了,但很想自己在Mars College搞一个。
                        </p>
                        <p className="px-4 mt-10 text-black font-mono italic">
                            今年3月18号的时候我和Jmill在Mars College结婚了。接着休息了一天后便开始和Mars College的人一起组织这个活动。
                            举办这个活动的最佳时机在4月1号,也就是小有名气的Bombay Beach Biennale (双年展)的第三天,那时候会有很多游客和艺术家来这里露营,做装置艺术,做活动。
                            而我们也需要在两个星期的时间里找参与者,做自己的作品,搞场地布局。
                            非常感谢免费提供场地的Gene,帮忙布置场地的Nico,做了一个酷炫logo的kirby,照着酷炫logo做了一个酷炫招牌的Will,以及我会下面介绍的所有参与者。所有的作品的都可以在这个网站里看到：<a className='underline ' href='https://www.bbyi.fyi/'>https://www.bbyi.fyi/</a>
                        </p>
                        <p className="px-4 mt-10 text-black font-mono italic">
                            首先自卖自夸的介绍一下我和Jmill一起合作的作品。
                        </p>
                        <p className="px-4 mt-10 text-black font-mono mb-6 italic">
                            这个作品叫Obsidian Vault。就是著名的开源双链笔记管理工具。黑曜石是我在Salton Sea附近的一块地上捡的。当时我就觉得我可以做一个和Obsidian Notes相关的东西,但一直没想好要怎么呈现。
                            后来突发奇想可以让大家在一张紫色的post it上写下自己的笔记,以此来交换一颗黑曜石。结果这个作品超受欢迎,以至于最后石头都没有了还是有人在继续写笔记。我们无奈只能就地捡砾石作为交换:P。
                        ...
                        <p className="px-4 mt-10 text-black font-mono mb-6 italic">
                            我们做的第二个作品叫EitherRocks。来源于一个叫Ether Rocks的OG NFT项目。
                            刚好我在Salton Sea探索海军旧址的时候冒着被手榴弹炸死的危险,捡了一堆叫Gypsum的透明火山石,Jmill就提议可以做一个和Ether Rocks相关的作品。
                            因为所有的NFT都有traits来标明稀有度,于是我们觉得可以把Sims 1的traits用在石头上。
                            我们会根据Neat, Outgoing, Active, Playful, 和Nice这五大指标仔细感受每块石头的特质打分,并写在包装上。
                        ...
                        <p className="px-4 mt-10 text-black font-mono mb-6 italic">
                            Vincent是一个“多功能”艺术家,他能通过touch designer将软件和硬件串起,经常做出一些非常惊艳的高质量作品。
                            他在黑市里做了一个装置艺术叫Shadow Selfies,我更愿意称它为AI吐槽机器人。
                        ...
                        <p className="px-4 mt-10 text-black font-mono mb-6 italic">
                            ...
                            Mars College有四个部门,分别代表水,土,火,空。他在去年的Mars College给代表火神的Chatsubo赋予了一个非常热辣的性格。
                        ...
                        <p className="px-4 mt-10 text-black font-mono mb-6 italic">
                            互联网黑市当然也少不了用吃的做文章。历年来有做饼干的,代表HTTP Cookie。有做覆盆子派的(Raspberry Pi)。
                        ...
                        <p className="px-4 mt-10 text-black font-mono mb-6 italic">
                            右边则是由Jmill出的主意,由我来执行的Instagram Mat。这是一个非常Meta的作品（双关语注意）。这也是我第一次和国内的厂家合作。
                        ...
                        <p className="px-4 mt-10 text-black font-mono mb-6 italic">
                            ...
                            这次的logo是一个鱼骨头,代表着Salton Sea被污染后成片的死鱼骨头变成了海滩。
                        ...
                        <p className="px-4 mt-10 text-black font-mono mb-6 italic">
                            ...
                            这次组织后的感受就是Bombay Beach的双年展是一个很注重Giving的地方。有点类似于火人节,大家都会免费赠送彼此一些东西。
                            其中最火爆的莫过于Obsidian Vault这个作品,互动性很强,大家也在交互的过程中感到非常的开心。
