                ...
                <div className="mx-auto mt-6 text-gray-500 bg-white relative">
                    ...
                    <div className="xl:flex flex-col justify-center  h-full  border-black">
                        ...
                        <p className="px-4 mt-10 text-black font-mono italic">
                            事情的起因是这样的。去年10月的时候我和Jmill(现在的老公，当时的男朋友)去迈阿密探望朋友M和F，在他们的公寓大楼里散步的时候，M说他们打算在一月份搞一个Internat Yami-ichi，翻译过来就是网络黑市。
                            起源于2012年的日本东京，由一个叫IDPW的网络社团组织。一开始的起因是因为社员做的iOS app被苹果公司拒绝了，理由竟然是不够有用和娱乐性不足。一气之下他们决定把网络带到现实世界，和人面对面交互，于是就有了这个活动。
                        ...
                        <p className="px-4 mt-10 text-black font-mono mb-6 italic">
                            ...
                            他的脑洞经常非常的到点。比如这次的网络黑市他就做了一个免费的Facebook注册表共大家填写。里面的细节非常有梗。
                        </p>
                        <div className="flex ">
                        ...
                        <p className="px-4 mt-10 text-black font-mono mb-6 italic">
                            网络黑市当然也少不了用吃的做文章。历年来有做饼干的，代表HTTP Cookie。有做覆盆子派的(Raspberry Pi)。
