              ...
              <div className="w-full  xl:w-1/2 flex flex-col items-center justify-center  border-b-2 border-black">
                <table className="w-full text-center">
                  <tbody className="text-black font-mono text-start">
                    ...
                    <tr className="border-t-2 border-b-2 border-black">
                      ...
                      <td className="px-4 py-2 italic ">Physical Box</td>
                    </tr>
                    <tr className="border-t-2 border-b-2 border-black">
                      <td className="px-4 py-2 font-bold ">Description</td>
                      <td className="px-4 py-2 italic ">
                        Hey you, are you emotionally intelligent? Come find out
                        :). Dive into the world of emotional intelligence with
                        our captivating and aesthetically pleasing creation!
                        More than just a deck of questions, our innovative game
                        combines engaging gameplay strategies with the
                        exploration of 6 distinct social archetypes.
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                >
                  <button className="mt-10 bg-[#05ce78] pb-2 text-black border border-black border-2 font-bold font-mono py-2 px-4 italic   mb-10">
                    📦 Reserve Your Copy on KickStarter! (Prelaunch, Coming
                    Soon)
                  </button>
                </a>
              </div>
