            ...
            <div className="relative divide-y-2 divide-black">
                <div className="mx-auto max-w-prose text-lg  ">
                    ...
                    <div className="flex flex-col items-center justify-center mt-2">
                        <Toggle label="中" checked={checked} onChange={handleToggleChange} />
                    </div>
                ...
                <div className="mx-auto mt-6 text-gray-500 bg-white relative">
                                ...
                                <table className="w-full text-center">
                                    <tbody className="text-black font-mono text-start">
                                        ...
                                        <tr className="border-t-2 border-b-2 border-black">
                                            ...
                                            <td className="px-4 py-2 italic ">Turn off, log-out, and drop in, on the real world. The Internet Yami-Ichi is a flea market for “browsing” face-to-face.</td>
                                        </tr>
                                    </tbody>
                                </table>
                                <a
                    ...
                    <div className="xl:flex flex-col justify-center  h-full  border-black">
                        ...
                        <p className="px-4 mt-10 text-black font-mono italic">
                            ...
                            made isn&apos;t entertaining or useful. This event spread all over the
                            world and was organized in a decentralized manner by various
                            ...
                            event information and photos on the official website. Jmill&apos;s eyes
                            lit up when he heard about this event, and although he couldn&apos;t
                            participate in the Miami Yami-Ichi, he really wanted to make one
                            happen at Mars College.
                        </p>
                        <p className="px-4 mt-10 text-black font-mono italic">
                        ...
                        <p className="px-4 mt-10 text-black font-mono mb-6 italic">
                            ...
                            but hadn&apos;t figured out how to present it. Eventually, the idea
                            came up that people could write their notes on a purple post-it
                            and exchange it for an obsidian rock. This project was so popular
                            that we ran out of obsidian, but people were still writing notes.
                            We had no choice but to pick up gravel from the yard to exchange
                            their notes :P. We received so much interesting knowledge that we
                            had to marvel at how varied the human brain can be. We even had
                            some people write notes linked to other notes (see bottom right).
                        </p>
                        <div className="flex">
                            <img
                        ...
                        <p className="px-4 mt-10 text-black font-mono mb-6 italic">
                            ...
                            responsible and comfortable to communicate with. But he doesn&apos;t
                            use social networking software at all and usually only
                            communicates by email and text message. One of his projects was a
                            free Facebook registration form for everyone to fill out. It&apos;s
                            super detailed, focused, and intriguing. Only issue is that the
                            registration turnaround time right now is around 12-15 business
                            days.
                        </p>
                        <div className="flex ">
                            <img
                        ...
                        <p className="px-4 mt-10 text-black font-mono mb-6 italic">
                            Vincent is a &quot;multi-functional&quot; artist who is able to link
                            software and hardware through the Touch Designer software. He set
                            up an installation for the Yami-Ichi called Shadow Selfies, which
                            I prefer to call an AI roasting machine. When you get close to the
                            mirror, it automatically takes a picture of you and then uses
                            OpenAI&apos;s GPT-3 to analyze your appearance, generate a paragraph to
                            cyber-bully you and broadcast it in a robotic female voice
                        </p>
                        <div className="flex ">
                            <img
                                className="w-1/2 border-b-2 border-t-2 border-r-2 border-black"
                        ...
                        <p className="px-4 mt-10 text-black font-mono mb-6 italic">
                            ...
                            her, I feel like I&apos;m in a warm spa holding a mint-flavored cold
                            drink. She bought two headphone headbands and made the headphone
                            cups with obsidian and palm leaves respectively. I feel my brain
                            will automatically shift into nature once I put them on.
                        </p>
                        <p className="px-4 mt-10 text-black font-mono mb-6 italic">
                            ...
                            represents the Fire God, a very hot character at last year&apos;s Mars
                            College. Chatsubo is a bit of a cynical old man, speaking very
                            directly, sometimes very rude, but with a very human touch. This
                            booklet is a collection of conversations between Martians and
                        ...
                        <p className="px-4 mt-10 text-black font-mono mb-6 italic">
                            ...
                            intended). This is also the first time I&apos;ve worked with a Chinese
                            manufacturer. I was very excited when I received the test batch. I
                            felt very accomplished seeing the idea come to fruition.
                        </p>
                        ...
                        <p className="px-4 mt-10 text-black font-mono mb-6 italic">
                            ...
                            polluted Salton Sea beach. The fish&apos;s eye is Apple&apos;s loading
                            cursor.
                        </p>
                        <p className="px-4 mt-10 text-black font-mono mb-6 italic">
                        ...
                        <p className="px-4 mt-10 text-black font-mono mb-6 italic">
                            ...
                            place. It&apos;s a bit similar to the Burning Man Festival, where there
                            is no money or commerce and all things are gift exchanges. One of
                            the most popular works at our Yami-Ichi was the Obsidian Vault,
                            which was free, interactive and everyone had a lot of fun
                            ...
                            creativity. We made a lot of &quot;useless&quot; stuff, but we attracted a
                            lot of people who are just as weird as we are to appreciate our
                            work. We may have not made any money, but we got a lot of
                            psychologically enriching experiences which may be even more
                            valuable.
                        </p>
                    </div>
                </div>
